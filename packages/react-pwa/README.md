...
<div align="center">
  <a href="https://npmjs.com/package/@jop/react-pwa">
    <img alt="npm downloads" src="https://img.shields.io/npm/dm/@jop/react-pwa.svg" />
  </a>
  <a href="https://bundlephobia.com/result?p=@jop/react-pwa">
    <img alt="bundle size" src="https://badgen.net/bundlephobia/minzip/@jop/react-pwa" />
  </a>
</div>
...
React adapter for [`@jop/pwa-core`](https://github.com/jopgood/pwa/tree/main/packages/pwa-core). Hooks and a provider for push subscriptions, service worker lifecycle, and permissions.
